...
{
    class ShotgunBuy : Buyable
    {
        public ShotgunBuy(Vector2f pos)
        {
            //Set price
            _price = 3000;
            _maxNbrOfBuy = 10;
            ...
            //Set graphic handler
            _graphicHandler.AddGraphicObject("Base", new GameSprite(48, 80, 16, 16));
        ...
        {
            _player.SwitchWeapon(new Shotgun());
        }
